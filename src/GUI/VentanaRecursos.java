...
public class VentanaRecursos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Recursos Registrados");
    ...
    private void buttonCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCrearActionPerformed
        new CrearRecurso(tabla).setVisible(true);
    ...
    private void buttonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEliminarActionPerformed
        ...
        String sql = "DELETE FROM public.recurso WHERE id_recurso = " + tabla.getValueAt(tabla.getSelectedRow(), 0) + ";";
        try {
    ...
    private void buttonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonModificarActionPerformed
        ...
        new CrearRecurso(tabla,
                (int) tabla.getValueAt(tabla.getSelectedRow(), 0),
                tabla.getValueAt(tabla.getSelectedRow(), 1) == null ? null : (Integer) tabla.getValueAt(tabla.getSelectedRow(), 1),
                (String) tabla.getValueAt(tabla.getSelectedRow(), 2),
                (int) tabla.getValueAt(tabla.getSelectedRow(), 3)
        ).setVisible(true);
